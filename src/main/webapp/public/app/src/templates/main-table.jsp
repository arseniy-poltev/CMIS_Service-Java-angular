<div class="clearfix" prevent="true" ng-click="selectOrUnselect(null, $event)"  ng-right-click="selectOrUnselect(null, $event)">
    <table class="table mb0 table-files noselect">
            ...
            <tr>
                <th>
                    <a href="" ng-click="order('model.name')">
                        {{"name" | translate}}
                        <span class="sortorder" ng-show="predicate[1] === 'model.name'"
                ...
                <th class="hidden-xs" ng-hide="config.hideSize">
                    <a href="" ng-click="order('model.size')">
                        {{"size" | translate}}
                        <span class="sortorder" ng-show="predicate[1] === 'model.size'"
                            ng-class="{reverse:reverse}"></span>
                    </a>
                </th>
                <th class="hidden-sm hidden-xs" ng-hide="config.hideDate">
                    <a href="" ng-click="order('model.date')">
                        {{"date" | translate}}
                        <span class="sortorder" ng-show="predicate[1] === 'model.date'"
                            ng-class="{reverse:reverse}"></span>
                    </a>
                </th>
        ...
        <tbody class="file-item">
            ...
            <tr class="item-list"
                ...
                ng-show="!fileNavigator.requesting" ng-click="selectOrUnselect(item, $event)"
